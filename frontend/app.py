...
backend_url = st.text_input('Backend prediction endpoint', 'https://YOUR-BACKEND-SPACE.hf.space/predict')
...
if submitted:
    payload = {
        ...
        'MRP_per_Weight': product_mrp / product_weight if product_weight else product_mrp,
    }
    try:
